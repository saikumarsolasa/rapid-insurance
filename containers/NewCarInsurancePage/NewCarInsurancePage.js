...
import { GetAllLocations, GetInsuranceCompanies, GetPcManufacturers, GetPcModels, GetPcVarients } from 'helper/api';
import { newCarInsuranceRadios, newCarInsuranceInitialValues } from 'helper/formik-initial-values';
import { newBikeInsuranceValidation } from 'helper/formik-validations';
import { Input } from 'helper/formikFields/input';
import { useEffect, useState } from 'react';
import styles from './NewCarInsurancePage.module.scss';
...
const NewCarInsuranceForm = (props) => {
  ...
  return (
    <div className={styles.MainWrapper}>
      <Formik initialValues={newCarInsuranceInitialValues()} validationSchema={newBikeInsuranceValidation()} onSubmit={onSubmitHandler}>
        {(formik) => {
          return (
            <Form>
              ...
              <div className={styles.formMainWrapper}>
                <div className={classNames(styles.formWrapper, 'py-4')}>
                  <motion.div {...routeAnimation} className="offset-lg-2">
                    <RadioSet name="c_customer_type" label="Customer Type" options={newCarInsuranceRadios.companyArray} defaultInput="I" />
                    <RadioSet name="c_plan" label="Plan Type" options={newCarInsuranceRadios.planArray} defaultInput="CP-1-TP-2" />
...
export default NewCarInsuranceForm;
