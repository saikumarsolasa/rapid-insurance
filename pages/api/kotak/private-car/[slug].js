...
import {
    KotakPCPolicyDocumentMainHandler,
    KotakPCPremiumMainHandler,
    KotakPCProposalMainHandler,
} from "serverHelper/serverSideFunctions/kotak/privateCar";
import {
    KotakPcPremiumCtoS,
    KotakPcPremiumStoC,
    KotakPcProposalCtoS,
...
export default function handler(req, res) {
    ...
    switch (slug) {
        ...
        case "policy-document":
            if (req.method === "POST") KotakPCPolicyDocumentMainHandler(req, res);
            break;
