    ...
    <>
      <div className={styles.transactionDetails}>
        ...
        <div className={styles.transactionDetail}>
          ...
          <p className="h6 text-primary">{details.idv}</p>
        </div>
        <div className={styles.transactionDetail}>
      ...
      <div className={styles.transactionAmount}>
        <div className={styles.transactionAmountItem}>
          ...
          <p>&#8377;&nbsp;{Math.round(details.basic_od - details.ncb_discount)}</p>
        </div>
        <div className={styles.transactionAmountItem}>
          <p className="h6">Third Party premium (B)</p>
          <p>&#8377;&nbsp;{Math.round(details.third_party_premium)}</p>
        </div>
        <div className={styles.transactionAmountItem}>
          <p>Basic OD</p>
          <p>&nbsp;&nbsp;{Math.round(details.basic_od)}</p>
        </div>
        <div className={styles.transactionAmountItem}>
          {/* <p>GST Amount</p>
        ...
        <div className={styles.transactionAmountItem}>
          <p>No Claim Bonus</p>
          <p>&nbsp;&nbsp;{Math.round(details.ncb_discount)}</p>
        </div>
