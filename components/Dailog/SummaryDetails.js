            ...
            <div className={styles.details}>
              <div className={styles.details_list}>
                ...
                <p className={styles.details_list_value}>
                  {data.query.c_make},&nbsp;{data?.query.c_model},&nbsp;{data?.query.c_variant}
                </p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Fuel&nbsp;Type</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_fuel_type}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Vehicle&nbsp;Registration&nbsp;Type</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_customer_type === 'I' ? 'Individual' : 'Company'}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Plan&nbsp;Type</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_plan}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Registration&nbsp;Date</p>
                <p>:</p>
                <p className={styles.details_list_value}>{new Date(data?.query.c_registration_date).toLocaleDateString('en-GB')}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Manufacturing&nbsp;Date</p>
                <p>:</p>
                <p className={styles.details_list_value}>{new Date(data?.query.c_manufacture_year_month).toLocaleDateString('en-GB')}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Vehicle&nbsp;Insurer&nbsp;Type</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_rollover === true ? 'Renew' : 'New'}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>RTO</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_place_of_registration.replace(' ', ', ')}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Name</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_full_name}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Mobile</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_mobile}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Email</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_email}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Previous&nbsp;Insurer&nbsp;Name</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_prev_previous_insurer}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Previous&nbsp;Policy&nbsp;Expire&nbsp;Date</p>
                <p>:</p>
                <p className={styles.details_list_value}>{new Date(data?.query.c_prev_policy_expire_date).toLocaleDateString('en-GB')}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Claimed&nbsp;in&nbsp;past&nbsp;year</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_claim_last_year === false ? 'No' : 'Yes'}</p>
              </div>
              <div className={styles.details_list}>
                <p className={styles.details_list_key}>Previous&nbsp;No&nbsp;Claim&nbsp;Bonus(NCB)</p>
                <p>:</p>
                <p className={styles.details_list_value}>{data?.query.c_ncb}&#37;</p>
              </div>
            </div>
