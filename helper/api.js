...
export const GetManufacturers = async () => {
  const { data } = await axios.get('http://localhost:3000/api/vehicle/two-wheeler/manufacturers');
  return data;
};

export const GetModels = async (manufacturer_code) => {
  const values = { manufacturer_code };
  const { data } = await axios.post('http://localhost:3000/api/vehicle/two-wheeler/models', values);
  return data;
};

export const GetVarients = async (manufacturer_code, model_code) => {
  const values = { manufacturer_code, model_code };
  const { data } = await axios.post('http://localhost:3000/api/vehicle/two-wheeler/variants', values);
  return data;
};

export const GetPcManufacturers = async () => {
  const { data } = await axios.get('http://localhost:3000/api/vehicle/private-car/manufacturers');
  return data;
};

export const GetPcModels = async (manufacturer_code) => {
  const values = { manufacturer_code };
  const { data } = await axios.post('http://localhost:3000/api/vehicle/private-car/models', values);
  return data;
};

export const GetPcVarients = async (manufacturer_code, model_code) => {
  const values = { manufacturer_code, model_code };
  const { data } = await axios.post('http://localhost:3000/api/vehicle/private-car/variants', values);
  return data;
};
...
export const GetState = async () => {
  const { data } = await axios.get('http://localhost:3000/api/rto/states');
  return data;
};

export const GetLocations = async (state_code) => {
  const values = { state_code };
  const { data } = await axios.post('http://localhost:3000/api/rto/locations', values);
  return data;
};

export const GetAllLocations = async () => {
  const { data } = await axios.get('http://localhost:3000/api/rto/all-locations');
  return data;
};

export const GetPcState = async () => {
  const { data } = await axios.get('http://localhost:3000/api/rto/pc-states');
  return data;
};

export const GetPcLocations = async (state_code) => {
  const values = { state_code };
  const { data } = await axios.post('http://localhost:3000/api/rto/pc-locations', values);
  return data;
};

export const GetPcAllLocations = async () => {
  const { data } = await axios.get('http://localhost:3000/api/rto/pc-all-locations');
  return data;
};

export const GetTwState = async () => {
  const { data } = await axios.get('http://localhost:3000/api/rto/tw-states');
  return data;
};

export const GetTwLocations = async (state_code) => {
  const values = { state_code };
  const { data } = await axios.post('http://localhost:3000/api/rto/tw-locations', values);
  return data;
};
...
export const GetRtoDetails = async (location_code) => {
  ...
  const { data } = await axios.post('http://localhost:3000/api/rto/rto-details', values);
  return data;
};
...
export const GetInsuranceCompanies = async () => {
  const { data } = await axios.get('http://localhost:3000/api/insurance_companies');
  return data;
};

export const GetPremiumQuotes = async (values) => {
  const { data } = await axios.post('http://localhost:3000/api/two-wheeler/premium', values);
  return data;
};

export const GetPcPremiumQuotes = async (values) => {
  console.log('val', values);
  const { data } = await axios.post('http://localhost:3000/api/private-car/premium', values);
  return data;
};

export const PostTwoWheelerBuyNow = async (values) => {
  const { data } = await axios.post('http://localhost:3000/api/two-wheeler/buy-now', values);
  return data;
};

export const GetOtp = async (values) => {
  const { data } = await axios.post('http://localhost:3000/api/auth/send-otp', values);
  return data;
};

export const VerifyOtp = async (values) => {
  const { data } = await axios.post('http://localhost:3000/api/auth/verify-otp', values);
  return data;
};
